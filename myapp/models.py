...
class Animal_dog(models.Model):
    ...
    History = models.CharField(max_length=1000,default='Sorry we do not have much history on this dog.')
...
class other_animals(models.Model):
    ...
    Description = models.CharField(max_length=1000,default='')
    History = models.CharField(max_length=1000,default='Sorry we do not have much history on this Animal.')
...
class Favorites(models.Model):
    ...
    def __str__(self):
        return f"{self.user.username}'s Favorite - {self.get_animal_type_display()}"
